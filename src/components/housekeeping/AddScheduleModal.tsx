  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-3xl shadow-premium-xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col"
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-5 relative overflow-hidden shrink-0">
          <div
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-white font-display">Add Housekeeping Schedule</h2>
                <p className="text-emerald-100 text-sm">Assign a cleaning task to a staff member</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
              ...
              {TASK_TYPES.map(t => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 leading-tight mt-0.5">{t.desc}</p>
                  </div>
                </button>
              ))}
            </div>
          ...
          {isFormValid && (
            <motion.div
              ...
              className="bg-gradient-to-r from-emerald-50 to-emerald-50/50 border border-emerald-200 rounded-2xl p-4"
            >
        ...
        <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between bg-slate-50/50 shrink-0">
          ...
          <div className="flex gap-3">
            ...
            <motion.button
              ...
              className={cn(
                'px-6 py-2.5 text-sm font-semibold rounded-xl flex items-center gap-2 transition-all',
                !saving && isFormValid
